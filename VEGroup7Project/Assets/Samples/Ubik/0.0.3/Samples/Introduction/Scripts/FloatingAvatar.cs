...
namespace Ubik.Samples
{
    ...
    public class FloatingAvatar : MonoBehaviour
    {
        ...
        public SkinnableAvatar skinnable;
        ...
        private void OnEnable ()
        {
            ...
            if (skinnable)
            {
                skinnable.OnSkinUpdated.AddListener(SkinnableAvatar_OnSkinUpdated);
            }
        }
        ...
        private void OnDisable ()
        {
            ...
            {
                skinnable.OnSkinUpdated.RemoveListener(SkinnableAvatar_OnSkinUpdated);
            }
        }
        ...
        private void SkinnableAvatar_OnSkinUpdated (Texture2D skin)
        {
